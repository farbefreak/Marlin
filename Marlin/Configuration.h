...
#define STRING_CONFIG_H_AUTHOR "(Stephan, MKS Robin Nano)" // Who made the changes.
 ...
 */
    ...
    #define Z_DRIVER_TYPE  TMC2130_STANDALONE //Sapphire Pro
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 220, 220, 10, 500 } //über 230XY rattert
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 150, 8000 } //mehr gaaas
 ...
 *
 */
#define Z_MIN_PROBE_PIN PA2 // PW detect pin wird benutzt für BL_Touch
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -8, -2.87 } 
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M150 R255 \n G4 P800 \n M150 R0 \n G4 P800 \n M150 R255 \n G4 P800 \n M150 R0 \n G4 P800 \n M150 R255 \n M600"
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (75*60) //schneller
#define HOMING_FEEDRATE_Z  (10*60) //schneller
...
#define SAPPHIRE_GRAPHICAL_TFT //fürs LCD
...
// Folgende werte für sapphire pro
